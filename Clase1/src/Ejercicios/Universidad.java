...
public class Universidad {
    ...
    public Universidad(){
        ...
        alumnos= new Estudiante[MAX_ALUMNOS];
        creaAlumnos();
    ...
    public boolean darClase(){
        ...
        if(!profesor.isAsistencia()){
            ...
            System.out.println("La materia del profesor y del aula no es "
                    + "la misma, no se puede dar clase");
            return false;
    ...
    public void notas(){
        ...
        System.out.println("Hay "+chicosApro+" chicos y "+chicasApro
                +" chicas aprobados/as");
